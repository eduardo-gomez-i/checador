...
//echo $pagina_actual;
    ...
    $consulta=mysql_query("SELECT * FROM checador_last WHERE id='1'");
    $nueva_tarjeta=mysql_result(mysql_query("SELECT tarjeta FROM newcard WHERE conocida='NO' AND id='1'"), 0);
      ...
      <div class="card-body" >
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-image">
                <?php if (empty($foto)) {
                  ...
                  }else{ $imagen="dist/img/".$foto.".jpg"; }
                ?>
                <img class="img-circle elevation-2" src="<?php echo $imagen; ?>" alt="Foto del Trabajador">
              </div>
              <div class="card-footer">
                <p class="widget-user-username text-center"><?php echo $trabajador; ?> - <?php echo $puesto; ?><?php if (empty($trabajador)){ echo "PASE SU TARJETA - ";} ?></p>
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header">H. Entrada</h5>
                      <span class="description-text"><?php echo $entrada; ?><?php if (empty($entrada)){ echo "esperando";} ?></span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      ...
                      <span class="description-text"><?php echo $salida; ?><?php if (empty($salida)){ echo "esperando";} ?></span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-4">
                    <div class="description-block">
                      ...
                      <span class="description-text"><?php echo $trabajo_horas; ?><?php if (empty($trabajo_horas)){ echo "esperando";} ?></span>
                    </div>
                    <!-- /.description-block -->
                  </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <div class="row">
          ...
          <?php 
            ...
            }else{ $estatus="NADA"; $estilo="bg-purple"; $icono='<i class="fas fa-info-circle"></i>';}
            if (!empty($nota)) {
...
<script>
  ...
  function loop() { var looptimer = setInterval(actualizar, 1000); } //en milisegundos
  ...
  setTimeout(function () { inicio(); }, 500); //en milisegundos
    
  //ejecuta el loop despues de x segundos de iniciar
  setTimeout(function () { loop(); }, 1000); //en milisegundos
</script>
<!-- datos comparativos -->
