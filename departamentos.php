<?php
$titulo_pagina = "Departamentos | Checador Universal";
include 'header.html';
include 'sidebar.php';
...
if (isset($_POST['btn_agregar'])) {
    ...
    $sql_agregar_departamento = "INSERT INTO departamentos (departamento) VALUES ('$departamento_agregar')";
    ...
    if ($resultado_agregar_departamento) {
        ...
        echo "<script>window.location.replace('departamentos.php');</script>";
    } else {
...
if (isset($_POST['btn_guardar'])) {
    ...
    $sql_editar_departamento = "UPDATE departamentos SET departamento='$departamento_editar' WHERE id=$id_departamento_editar";
...
if (isset($_POST['btn_eliminar'])) {
    ...
    $sql_eliminar_departamento = "DELETE FROM departamentos WHERE id=$id_departameto_eliminar";
                                        ...
                                        <table class="table table-striped table-bordered" style="width:100%" data-pagecount="1">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row_departamentos = mysqli_fetch_array($consulta_departamentos, MYSQLI_ASSOC)) {
                                                    ...
                                                    $consulta_trabajadores = mysqli_query($conexion, "SELECT * FROM trabajadores WHERE id_departamento=$id_departamento");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" method="POST" id="form_eliminar">
                    ...
                    <div class="row">
                        <div class="col">
                            <label>Seguro que desea eliminar este Departamento?</label>
