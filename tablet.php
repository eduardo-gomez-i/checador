...
<body class="hold-transition sidebar-mini">
                  ...
                  <div class="row">
                    <div class="col-sm-2 border-right">
                      <div class="description-block">
                        ...
                        <span class="description-text"><?= $entrada; ?> <?php if (empty($entrada)) {
                                                                          echo "esperando";
                                                                        } ?></span>
                      </div>
                      <!-- /.description-block -->
                    ...
                    <div class="col-sm-2 border-right">
                      <div class="description-block">
                        ...
                        <span class="description-text"><?= $scomida; ?> <?php if (empty($scomida)) {
                                                                          echo "esperando";
                                                                        } ?></span>
                      </div>
                      <!-- /.description-block -->
                    ...
                    <div class="col-sm-2 border-right">
                      <div class="description-block">
                        ...
                        <span class="description-text"><?= $rcomida; ?> <?php if (empty($rcomida)) {
                                                                          echo "esperando";
                                                                        } ?></span>
                      </div>
                      <!-- /.description-block -->
                    ...
                    <div class="col-sm-2 border-right">
                      <div class="description-block">
                        ...
                        <span class="description-text"><?= $salida; ?> <?php if (empty($salida)) {
                                                                          echo "esperando";
                                                                        } ?></span>
                      </div>
                      <!-- /.description-block -->
                    ...
                    <div class="col-sm-2">
                      <div class="description-block">
                        ...
                        <span class="description-text"><?= $horas_trabajadas; ?> <?php if (empty($horas_trabajadas)) {
                                                                                    echo "esperando";
                                                                                  } ?></span>
                      </div>
                      <!-- /.description-block -->
  ...
  <!-- Audio Files-->
  <audio id="beep-ok">
    <source src="dist/sounds/beep-ok.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="beep-error">
    <source src="dist/sounds/beep-error.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="beep-new">
    <source src="dist/sounds/beep-new.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="intente-mas-tarde">
    <source src="dist/sounds/intente-mas-tarde.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="beep-cambio">
    <source src="dist/sounds/beep-cambio.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="bienvenido">
    <source src="dist/sounds/bienvenido.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="buen-provecho">
    <source src="dist/sounds/buen-provecho.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="hola-de-nuevo">
    <source src="dist/sounds/hola-de-nuevo.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="nos-vemos">
    <source src="dist/sounds/nos-vemos.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <audio id="nueva-tarjeta">
    <source src="dist/sounds/nueva-tarjeta.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <!--ANUNCIO PROMOCIONAL-->
  <audio id="promo">
    <source src="dist/sounds/promo.mp3" type="audio/mpeg">Tu navegador no soporta reproduccion de audio
  </audio>
  <?php
