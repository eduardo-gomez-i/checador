...
<head>
  ...
  <title>Inicio | Checador Universal</title>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">#  De Trabajadores</div>
	                    <?php
			          		$query=mysqli_query($conexion1, "SELECT COUNT(id) as cant_trabajadores FROM trabajadores");
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Costo Nomina (Mensual)</div>
                      	<?php
			          		$query=mysqli_query($conexion1, "SELECT SUM(sueldo) as nomina FROM trabajadores");
              ...
              <!--<div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_check.png" alt="">
                  </div>
