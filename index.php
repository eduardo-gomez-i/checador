              ...
              <table class="table table-striped table-bordered display" id="miTabla" style="width:100%">
                <thead class="bg-light">
                  <tr>
                    ...
                    <th onclick="sortTable(1)">Costo de nomina</th>
                  </tr>
                </thead>
                <tbody>
                  <?php

                  $sql_trabajadores = "SELECT departamentos.departamento, count(trabajadores.id) as contador, SUM(trabajadores.sueldo) AS suma FROM checador.departamentos
                  ...
                  if (mysqli_num_rows($lista) > 0) {
                    while ($row = mysqli_fetch_assoc($lista)) {
                      ...
                      $suma_trabajadores = $row["suma"];
                  ?>
                      <tr>
                        <td><?= $nombre_departamento; ?></td>
                        <td><?= $contador_trabajadores; ?></td>
                        <td>$ <?= $suma_trabajadores ? number_format($suma_trabajadores, 2, '.', ',') : 0; ?></td>
                      </tr>
                  <?php
                    }
                  }
