...
if ($tarjeta) {
  ...
  // Si la tarjeta no existe actualiza la tabla new
  if (empty($row_trabajador['id'])) {
  ...
  if (!empty($row_trabajador)) {
    ...
    if (!empty($row_asistencia)) {
      ...
      $espera_hora_llegada = date('H:i:s', strtotime("$hora_entrada + 1 minute"));
      $espera_hora_salida_comida = date('H:i:s', strtotime("$hora_comida_salida + 1 minute"));
      $espera_hora_llegada_comida = date('H:i:s', strtotime("$hora_comida_llegada + 1 minute"));
      $espera_hora_salida = date('H:i:s', strtotime("$hora_salida + 1 minute"));
